...
const Quiz = () => {
    ...
    const onClickNext = () => {
        // Update results based on the current answer
        setResult((prev) =>
            selectedAnswer
                ? {
                    ...prev,
        ...
        // Clear selections (before moving to the next question)
        setSelectedAnswerIndex(null);
        setShowFeedback(false);
        setSelectedAnswer(''); 
        setIsCorrect(false);

        // Advance or finish based on questionSet.length (9)
    ...
    const restartQuiz = () => {
        // Shuffle and select 9 new questions
    ...
    const hasPassed = result.correctAnswers >= PASSING_SCORE;
                        ...
                        {hasPassed ? (
                            ...
                            <>
                                ...
                                <p style={{
                                    ...
                                    {/* Score Tiers (based on original logic) */}
